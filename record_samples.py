...
def record(number_of_chunks,len_trim_silence):
    """
...
def record_to_file(path, number_of_chunks,len_trim_silence):
    ...
    sample_width, data = record(number_of_chunks,len_trim_silence)
...
if __name__ == '__main__':
    ...
    record_multiple_samples_to_folder(path, number_of_samples,number_of_chunks,len_trim_silence)
